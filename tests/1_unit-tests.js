...
suite('Unit Tests', function () {
  ...
  suite('Equality', function () {
    ...
    test('#equal, #notEqual', function () {
      ...
      ); // reference data Types evalute to true if they have same reference
      assert.equal(6 * '2', '12');
  ...
  suite('Comparisons', function () {
    ...
    test('#approximately', function () {
      ...
      assert.approximately(weirdNumbers(0.2), 1, 0.8); // difference between delta - Math.random will always be less than 1-delta
    });
  });
